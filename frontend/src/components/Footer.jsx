...
export default function Footer() {
  return (
    <footer className="pt-24 pb-8 px-6 md:px-12 max-w-7xl mx-auto relative overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute top-0 w-full flex justify-center text-center pointer-events-none select-none z-0 overflow-hidden transform-gpu">
        <h2 className="text-[12vw] font-black text-on-surface-variant opacity-[0.03] tracking-tighter leading-none mt-4">RAUNAK</h2>
      </div>
      ...
      <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-12 border-b border-outline-variant/10 pb-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8">
          <a href="/#home" className="text-3xl font-black tracking-tighter text-primary font-headline">Raunak Gangwal</a>
        ...
        <div className="flex gap-4 sm:gap-6">
          ...
          <a href="https://www.linkedin.com/in/raunakgangwal/" target="_blank" rel="noopener noreferrer" className="group w-12 h-12 rounded-full bg-surface-container-high border border-outline-variant/30 flex items-center justify-center text-on-surface hover:text-[#0A66C2] hover:bg-[#0A66C2]/10 hover:border-[#0A66C2]/50 transition-all duration-300 transform-gpu hover:-translate-y-1 shadow-lg">
            <svg className="w-5 h-5 group-hover:scale-110 transition-transform transform-gpu" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
          </a>
        </div>
      ...
      <div className="w-full flex flex-col md:flex-row justify-between items-center pt-8 text-[10px] md:text-xs font-bold text-on-surface-variant uppercase tracking-widest gap-4 relative z-10 text-center md:text-left">
        <p>
          © {new Date().getFullYear()} Raunak Gangwal
