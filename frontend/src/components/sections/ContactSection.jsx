...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
      {/* Background Orbs */}
      <div className="absolute top-[20%] right-[-10%] w-[40%] h-[50%] bg-primary/10 blur-[150px] rounded-full pointer-events-none transform-gpu"></div>
      <div className="absolute bottom-[-10%] left-[-10%] w-[30%] h-[40%] bg-secondary/10 blur-[120px] rounded-full pointer-events-none transform-gpu"></div>
        ...
        <div className="lg:col-span-5">
          ...
          <div className="space-y-4">
            <a href="mailto:raunakgangwal22@gmail.com" className="group flex items-center p-4 bg-surface-container-lowest rounded-2xl border border-outline-variant/20 hover:border-primary/40 hover:shadow-[0_0_30px_rgba(186,158,255,0.1)] transition-all overflow-hidden relative">
              <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 transform-gpu"></div>
              <div className="w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center border border-primary/20 mr-4 relative z-10 group-hover:scale-110 transition-transform transform-gpu">
            ...
            <a href="https://www.linkedin.com/in/raunakgangwal/" target="_blank" rel="noopener noreferrer" className="group flex items-center p-4 bg-surface-container-lowest rounded-2xl border border-outline-variant/20 hover:border-[#0A66C2]/40 hover:shadow-[0_0_30px_rgba(10,102,194,0.1)] transition-all overflow-hidden relative">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0A66C2]/5 to-transparent translate-x-[-100%] group-hover:translate-x-0 transition-transform duration-500 transform-gpu"></div>
              <div className="w-12 h-12 bg-[#0A66C2]/10 rounded-xl flex items-center justify-center border border-[#0A66C2]/20 mr-4 relative z-10 group-hover:scale-110 transition-transform transform-gpu">
