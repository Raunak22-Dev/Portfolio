      ...
      <div className="relative border-l-2 border-outline-variant/20 ml-4 md:ml-8 pl-8 md:pl-16 space-y-16">
        {educationData.map((edu, idx) => (
          <div key={`edu-${idx}`} className="relative group">
            ...
            {/* Content Card */}
            <div className={`bg-gradient-to-br ${edu.color} to-surface-container-low/20 backdrop-blur-md border border-outline-variant/20 p-6 md:p-10 rounded-3xl shadow-xl hover:shadow-[0_20px_40px_rgba(0,0,0,0.3)] transition-all duration-500 transform-gpu hover:-translate-y-2`}>
