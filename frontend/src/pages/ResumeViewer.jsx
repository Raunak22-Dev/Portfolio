      ...
      <div className="w-full max-w-5xl relative z-10 animate-fade-in">
        ...
        <div className="w-full max-w-4xl mx-auto bg-white rounded-lg shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-outline-variant/10 aspect-auto md:aspect-[1/1.414] p-8 md:p-16 flex flex-col relative overflow-hidden text-black mt-8 transition-transform hover:scale-[1.01] duration-500">
          <div className="border-b-2 border-slate-200 pb-6 mb-8 text-center relative z-10">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-headline text-slate-800 tracking-tight mb-2">
              Student Name
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 mt-6 text-xs md:text-sm font-bold text-slate-500">
              <span className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[16px]">location_on</span> Global
                Hub
              </span>
              <span className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[16px]">mail</span>{" "}
                raunakgangwal22@gmail.com
              </span>
              <span className="flex items-center gap-1.5">
                <span className="material-symbols-outlined text-[16px]">code</span>{" "}
                github.com/Raunak22-Dev
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mt-4 text-left relative z-10">
            ...
            <div className="md:col-span-2 space-y-10">
              <section>
                <h3 className="text-lg font-bold text-slate-800 border-b-2 border-slate-200 pb-2 mb-6 uppercase tracking-widest text-primary">
                  Experience
                </h3>
                <div className="space-y-8">
                  <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-slate-600 space-y-2 leading-relaxed">
                      ...
                      <li>
                        Collaborated with QA to implement automated End-to-End Cypress testing.
                      </li>
                    </ul>
                  </div>
                  <div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 leading-relaxed">
                      Architected a machine learning model capable of predicting localized weather
                      events with 89% accuracy utilizing historical meteorological datasets.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <div className="md:col-span-1 space-y-8 bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-100 shadow-inner h-fit">
              <section>
                <h3 className="text-sm font-bold text-slate-800 uppercase tracking-widest mb-5 text-primary">
                  Education
                </h3>
                <div className="mb-4">
                  ...
                  <p className="text-xs font-bold text-primary mt-3 bg-primary/10 w-fit px-2 py-1 rounded border border-primary/20">
                    GPA: 3.8/4.0
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-700 shadow-sm">
                    React
                  </span>
                  <span className="px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-xs font-bold text-slate-700 shadow-sm">
                    Node.js
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none select-none overflow-hidden">
            <span className="text-[10rem] md:text-[14rem] font-black rotate-[-35deg] whitespace-nowrap text-slate-900 leading-none">
              DUMMY RESUME
            </span>
          </div>
        </div>
